        ...
        >
            <div class="list" ref="scrollcontent">
                ...
                <div v-if="isVisible('homepage')" :class="[`page`, `page-${'homepage'}`]">
                    ...
                    <md-button class="btn md-button-solid2 btn-58 " aria-label="x" style="left:1097px; top:52px;" @click="go2Page('signup')">Sign Up, It's Free</md-button>
                </div>
                ...
                <div v-if="isVisible('google')" :class="[`page`, `page-${'google'}`]">
                    ...
                    <wl-hot :rect="{x:553,y:324,w:298,h:33}" @click.native="go2Page('userhub')"/>
                </div>

                <userhub 
                  v-show="isVisible('userhub')" 
                  :class="[`page`]" 
                  :defaultNav="defaultUserhubNav"
