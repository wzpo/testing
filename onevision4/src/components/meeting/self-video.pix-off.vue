...
>
  <div id='self_video' 
    ...
    @mouseleave="mouseout"
  >
    <video id="camera" :class="{mirror: selfvideoMirror, hide: selfvideoBgEffect==='transparent'}" :width="videoW" :height="videoH" autoplay="true" ></video>
    <canvas id="cameracanvas" v-if="selfvideoBgEffect!==null" :class="{mirror: selfvideoMirror}" :width="videoW" :height="videoH"></canvas>
