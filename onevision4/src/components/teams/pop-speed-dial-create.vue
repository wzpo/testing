<template>
  <div id="pop-speed-dial-create"
    :class="[os, theme]"
  >
    <div id="pop-speed-dial-create-titlebar" class="head">
      <div class="head2">
        <div class="left">
          Webex
        </div>
    ...
    <div class="des">Create a speed dial</div>
    ...
    <div class="form-wrap">
      ...
      <div class="grp rw">
        <div class="cl">
          <md-label
              class="md-input__label"
              htmlFor="cb"
            >Phone<span class="required">*</span></md-label>
          <div class="combobox" ref="cb" htmlId="cb" @click="showDropdown('cb')" >
      ...
      <div class="grp">
        <div class="msg">This information will be used to create a contact, which you can edit at any time.</div>
      </div>

      <div class="btns">
        <md-button class="btn md-button-solid" :disabled="!valid" aria-label="x" :size="32" @click="addSpeedDial2">Create</md-button>
...
export default {
  ...
  beforeMount() {
    ...
    if (this.name) {
      ...
      if (!isNaN(this.name.replace(/ +/g, ''))) {
        this.callnumber = this.name
      } else {
        if (arr && arr[0]) {
          this.name1 = arr[0];
        }
  ...
  methods: {
    ...
    onInput1(evt){
      ...
      this.valid = this.name1 && this.callnumber;
    },
    onInput2(evt){
    ...
    addSpeedDial2() {
      ...
      var pname = _.trim(`${this.name1} ${this.name2}`);
      this.people = {
