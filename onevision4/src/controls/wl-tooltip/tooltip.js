...
export default class Tooltip {
  ...
  setOptions (options) {
    ...
    if (
      ...
      this.options.borderColor !== options.borderColor ||
  ...
  _ensureShown (reference, options) {
    ...
    if (popperOptions.modifiers === undefined) {
      ...
      popperOptions.modifiers.push(
        {
          ...
          options: {
            boundary: options.boundariesElement,
          },
        }
      )
    }

    this.popperInstance = createPopper(reference, tooltipNode, popperOptions)
    ...
    events.forEach(event => {
      switch (event) {
        case 'hover':
          ...
          if (this.options.hideOnTargetPress) oppositeEvents.push('mousedown')
          break
        case 'focus':
          ...
          break
        case 'click':
          directEvents.push('mousedown')
          oppositeEvents.push('mousedown')
          break
      }
    })
